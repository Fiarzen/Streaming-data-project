...
def test_publish_articles_sns(mock_publish_sns, mock_process, mock_search, client, sample_response):
...
def test_publish_articles_sqs(mock_publish_sqs, mock_process, mock_search, client, sample_response):
